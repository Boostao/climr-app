...
suppressPackageStartupMessages({
  if (!requireNamespace("archive", quietly = TRUE)) pak::pak("archive")
  if (!requireNamespace("base64enc", quietly = TRUE)) pak::pak("base64enc")
  if (!requireNamespace("bslib", quietly = TRUE)) pak::pak("bslib")
  if (!requireNamespace("data.table", quietly = TRUE)) pak::pak("data.table")
  if (!requireNamespace("DT", quietly = TRUE)) pak::pak("DT")
  if (!requireNamespace("grDevices", quietly = TRUE)) pak::pak("grDevices")
  if (!requireNamespace("htmltools", quietly = TRUE)) pak::pak("htmltools")
  if (!requireNamespace("htmlwidgets", quietly = TRUE)) pak::pak("htmlwidgets")
  if (!requireNamespace("jsonlite", quietly = TRUE)) pak::pak("jsonlite")
  if (!requireNamespace("leafem", quietly = TRUE)) pak::pak("r-spatial/leafem")
  if (!requireNamespace("leaflet.extras", quietly = TRUE)) pak::pak("leaflet.extras")
  if (!requireNamespace("leaflet", quietly = TRUE)) pak::pak("leaflet")
  if (!requireNamespace("rsvg", quietly = TRUE)) pak::pak("rsvg")
  if (!requireNamespace("shiny", quietly = TRUE)) pak::pak("shiny")
  if (!requireNamespace("terra", quietly = TRUE)) pak::pak("terra")
  if (!requireNamespace("webp", quietly = TRUE)) pak::pak("webp")
